  ...
  <div class="home content">
    ...
    <div class="cat-goods">
      ...
      <flexbox :gutter="0" wrap="wrap">
        <flexbox-item :span="1/3" style="padding:5px 2px 10px 2px;" v-for="(item,index) in scroller_data.data" :data-i="index>=6&&index<12" v-if="index>=6&&index<12" class="padding-tb-6 border-box cell-list-3">
    ...
    <div class="hot-sales">
      ...
      <flexbox :gutter="0" wrap="wrap">
        <flexbox-item style="padding:5px 2px 10px 2px;" :span="1/3" v-for="(item,index) in scroller_data.data" :data-i="index<6" v-if="index<6" class="padding-tb-6 border-box cell-list-3">
          <router-link :to="{name:'goods',query:{goods_id:item.goods_id,item_index:index}}" class="link-img">
            <div>
              <img :src="item.images?item.images.url:'/static/grentech/default.jpg'" alt="">
            </div>
