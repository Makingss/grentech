    ...
    <div style="height:100%">
      ...
      <div class="goods-desc" style="height:100%;padding-bottom:3rem;box-sizing:border-box">
        ...
        <div v-if="index==1" class="params-cell">
              <div @click="collapse(1)" v-if="goods_data_list.new_electrics.length!=0" :class="{'border-1px-b':!collapse1}" class="collapse_title color-danger bg-sliver padding-rl-10 padding-tb-6">
                电性能
              ...
              <div @click="collapse(3)" v-if="goods_data_list.new_standardfits.length!=0" :class="{'border-1px-b':!collapse3}" class="collapse_title color-danger bg-sliver padding-rl-10 padding-tb-6">
                标准配件
              ...
              <group class="margin-0" v-for="(item,index) in goods_data_list.new_standardfits" v-show="collapse3">
               ...
               <div @click="collapse(4)" v-if="goods_data_list.new_assemblies.length!=0" :class="{'border-1px-b':!collapse4}" class="collapse_title color-danger bg-sliver padding-rl-10 padding-tb-6">
                可选组件
