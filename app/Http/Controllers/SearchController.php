...
class SearchController extends Controller
{
	public function index(Request $request)
	{
		...
		$relations = $request->get('relations') ? $request->get('relations') : 'image_attach,goods_keywords';
...
//		$where = $filtered->all();
		...
		$goods = Good::search($query)->with(['image_attach','goods_keywords'])->paginate($per_page)->toArray();
